...
{
    m_players.push_back(make_unique<Mage> (m_window.convertIndexToPixel(1, 1), 1, 3, 0.17, 3, "Mage.png", false));

    m_staticObjects.push_back(make_unique<Wall>(m_window.convertIndexToPixel(1, 2), 1, 4, 0.17, 3, "skeleton2_v2.png"));
}
